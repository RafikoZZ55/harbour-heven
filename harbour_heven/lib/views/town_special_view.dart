...
class TownSpecialView extends ConsumerWidget {
const TownSpecialView({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref){

    final Player player = ref.watch(playerProvider);
    final List<Building> special = player.buildings.where((b) => BuildingType.special().contains(b.type)).toList(); 


    return ListView(
      children: special.map((e) => BuildingCard(buidingIndex:  player.buildings.indexOf(e))).toList(),
    );
  }
}